        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Bulk Class Assignment</h2>
                        <p class="text-gray-600 mt-1">Assign multiple students to classes at once</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="border border-gray-300 rounded-lg overflow-hidden max-h-64 overflow-y-auto">
                                    @foreach($classGroups as $gradeId => $classes)
