    ...
    <div class="flex items-center">
        ...
        <div>
            ...
            <p class="text-yellow-700 text-sm mt-1">
                <button onclick="loadBulkAssignmentTab()" class="underline hover:text-yellow-900">
...
<div class="space-y-6">
    @foreach($gradeLevelsWithClasses as $gradeLevel)
...
<script>
// Helper function to switch to bulk assignment tab
